...
print("data: {}".format([reverse_dictionary[x] for x in data[:8]]))
...
for num_skips, skip_window in [(2,1), (4,2)]:
    ...
    print("\nWith num_skips = {} and skip_window = {}:".format(num_skips,\
                                                                skip_window))
...
with graph.as_default(), tf.device("/cpu:0"):
    ...
    loss = tf.nn.sampled_softmax_loss(weights=softmax_weights, biases=softmax_biases, inputs=embed,
